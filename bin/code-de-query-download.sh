...
function usage {
  ...
  echo "  --curlOpts allows specifying special curl options like -o='--progress-bar --netrc-file=...myNetRc...file' --cookie-jar /tmp/t --location-trusted"  
  ...
  echo ""
  echo "A .netrc file must contain the single-sign-on machine sso.eoc.dlr.de and the login and password for your CODE-DE account."
  echo ""
