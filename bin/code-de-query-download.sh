...
function usage {
  echo "USAGE:"
  echo "$0 -c|--condition=... [-b|--baseurl=https://code-de.org] [-l|--limit=50] [-p|--parallel=1]"
  ...
  echo "  --baseurl of the CODE-DE services (default is https://code-de.org)"
